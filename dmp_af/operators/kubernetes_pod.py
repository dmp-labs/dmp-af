...
from dmp_af.common.constants import AZ_MI_BINDING_LABEL_NAME
from dmp_af.conf import Config
from dmp_af.parser.dbt_profiles import KubernetesTarget
...
class DbtKubernetesPodOperator(KubernetesPodOperator):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            ...
            **dmp_af_config.retries_config.k8s_task_retry_policy.as_dict(),
            **kwargs,
        )
    ...
    def execute(self, context: 'Context'):
        ...
        if self.dmp_af_config.k8s.airflow_identity_binding_selector:
            ...
            self.labels = {AZ_MI_BINDING_LABEL_NAME: self.dmp_af_config.k8s.airflow_identity_binding_selector}
