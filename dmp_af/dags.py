...
def dbt_main_dags(graph: DmpAfGraph) -> dict[str, DAG]:
    af_dags = {}
...
def compile_dmp_af_dags(manifest_path: str, config: Config, etl_service_name: Optional[str] = None) -> dict[str, DAG]:
    """
    Compiles airflow DAGs from manifest according to provided dmp-af config.
